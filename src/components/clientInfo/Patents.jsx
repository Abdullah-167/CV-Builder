                      ...
                      <div className="w-full">
                        <>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="mb-4">
                              <Label label="Patent Name" forHtml="patentName" />
                              <Input
                                name={"patentName"}
                                componentId={component.id}
                                value={component.patentName}
                            ...
                            <div className="mb-4">
                              <Label
                                label="Patent Number"
                                forHtml="patentNumber"
                              />
                              <Input
                                name={"patentNumber"}
                                componentId={component.id}
                                value={component.patentNumber}
                                handleInputChange={handleInputChange}
                              />
                            </div>
                            <div className="mb-4">
                              <Label label="Patent URL" forHtml="patentURL" />
                              <Input
                                name={"patentURL"}
                                componentId={component.id}
                                value={component.patentURL}
                                handleInputChange={handleInputChange}
                              />
                            </div>
                            <div className="mb-4">
