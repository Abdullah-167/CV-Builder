...
const PersonalInfo = ({ setPersonalInfoData, setPersonalInfoDescription }) => {
  ...
  const autoFillResponsibilitiesText = (desc) => {
    setPersonalInfoDescription(desc);
  ...
  const handleInputChangeSummary = (value) => {
        ...
        <div className="w-full col-span-2">
          <form>
            <div className="grid justify-start grid-cols-2 gap-3">
              <div className="mb-4">
                <div>
                  <Label label="First Name" forHtml="firstName" />
                  <Input
                    name={"firstName"}
              ...
              <div className="mb-4">
                <div>
                  <Label label="Last Name" forHtml="lastName" />
                  <Input
                    name={"lastName"}
        ...
        <div className="col-span-2">
          <div className="mt-6 relative">
            ...
            <ReactQuill
              ...
              handleInputChange={handleInputChangeSummary}
            />
            <button
