...
const Volunteering = ({ setVolunteeringData }) => {
  ...
  const addNewComponent = () => {
    ...
    setVolunteeringData(components)
  };
        ...
        {components.map((component, index) => (
          ...
          >
            <div className={`py-5 w-full flex justify-between`}>
              ...
              >
                <p>
                  {component.organisationName} {component.volunteeringTitle}{" "}
                </p>
                          ...
                          <div className="grid justify-start grid-cols-2 gap-6">
                            <div className="mb-4">
                              <Label
                                ...
                                forHtml="organisationName"
                              />
                              <Input
                                name={"organisationName"}
                                componentId={component.id}
                                value={component.organisationName}
                            ...
                            <div className="mb-4">
                              <Label
                                ...
                                forHtml="volunteeringTitle"
                              />
                              <Input
                                name={"volunteeringTitle"}
                                componentId={component.id}
                                value={component.volunteeringTitle}
                                handleInputChange={handleInputChange}
                              />
                            </div>
                            <div className="mb-4">
